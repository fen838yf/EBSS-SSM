...
def get_params():
    params = {
        'weight': 'runs/detect/yolo11-train/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': 'runs/detect/yolo11-C2PSAMamba-HAFB-WiseInnerMPDIoU-train/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model('ultralytics/datasets/dataset1/images/other', 'result')
